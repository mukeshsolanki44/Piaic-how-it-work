...
const IndexPage = () => (
    ...
    <div className="helo" >
      ...
      <div>
        <div className="number1">
          ...
          <p className ="pra1">PIAIC will launch classes in tde following locations, one city at a time, in tde following order
  ...
  <label for="radio01"><span></span></label>
      ...
      <div className="div">
  <input type="radio" id="radio01" name="radio" className = "input2" />
  <label for="radio01"><span></span></label>
      </div>
          </td>
...
<div style={{backgroundColor:"#e2e4e6"}}>
      ...
      <div className="number2">
        2
           ...
           To participate in the program and become eligible for the most prestigious credentials for AI, Cloud,
            and Blockchain technologies in the world, students must complete the following process
           </div>

           <div style={{lineHeight:"-10px",marginLeft:"20%",fontSize:"10px",marginTop:"30px"
           ,borderTop:"1px solid grey",paddingTop:"20px",width:"70%",paddingBottom:"5px",fontWeight:"bold"}}>
           <p className="numberPText">1- Submit the online application.</p>
           <p className="numberPText">2- Get admit card attested at a PIAIC office.</p>
           <p className="numberPText">3- Pass the entrance exam which consists of multiple choice English and Mathematics questions. Results are determined based on percentile.</p>
           <p className="numberPText">4- Pass all PIAIC exams with an average score of at least 70%.</p>
           </div>
...
<div className="number2">
        ...
        3
          ...
          <div className="numberText">
            All programs are one year long in duration. 
           Each program is divided into four quarters (12 weeks each).
           Classes are held once a week. In the initial stages, classes will be held
           only on Sundays. There will 3 sections of classes available, including Artificial 
           Intelligence, Cloud Native and Mobile Web Computing, and Blockchain. Each class will 
...
<div style={{backgroundColor:"#33322d"}}>
      ...
      <div className="number7">
        7
           ...
           For questions related to admissions, you may call us on the PIAIC Helpline: +92-311-1729526.<br/>
For technical questions related to coursework, you may contact us via the contact form. (https://www.piaic.org/contact).
    </div>   
